      ...
      <div className="max-w-[1240px] mx-auto grid md:grid-cols-2">
        ...
        <div className="flex flex-col justify-center">
          ...
          <p>
            ...
            optio enim rerum molestias magnam. Laboriosam, ipsa tenetur?
            Necessitatibus neque dolores a quisquam ex minus, quaerat doloremque
            porro soluta, aperiam earum!
          </p>
